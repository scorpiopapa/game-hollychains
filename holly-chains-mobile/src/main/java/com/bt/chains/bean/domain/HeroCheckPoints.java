 ...
 *
 */
@ApiObject(name = "HeroCheckPoints", description = "英雄关卡")
public class HeroCheckPoints extends Checkpoint {

	/**
	 * 
	 */
	private static final long serialVersionUID = 557183354613948336L;
	/**
	 * 关卡ID
	 */
