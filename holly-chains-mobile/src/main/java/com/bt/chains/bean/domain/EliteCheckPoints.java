 ...
 *
 */
@ApiObject(name = "EliteCheckPoints", description = "精英关卡")
public class EliteCheckPoints extends Checkpoint {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8512425465328290702L;
	/**
	 * 关卡ID
	 */
